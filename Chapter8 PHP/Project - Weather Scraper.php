<?php
    ...
    $weather = "";
    if($city) {
        $searchCity = str_replace(" ", "", $city);
        $url = "https://www.weather-forecast.com/locations/".$searchCity."/forecasts/latest";
        // city name without space
        if(url_exists($url)) {
            ...
            //break the page content into array, array[0] contains contents before string,
            // array[1] contains contents after string
            //echo $pageArray[1];
            $secondPageArray = explode('</span></p></td>', $pageArray[1]);
            $weather = $secondPageArray[0];
        }
         // check if weather existed
...
<head>
    ...
    <style type="text/css">
        html {
            background: url(Image/Sunset.jpg) no-repeat center center fixed;
